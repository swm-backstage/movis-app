...
import { changePassword, checkIdentifier, deleteUser, getIdentifierWithPhone, getUser } from "../api/user";
...
export { useGetUser, useCheckIdentifier, useGetIdentifier, useChangePassword, useMutateDeleteUser };